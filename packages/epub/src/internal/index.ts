...
import { decodeFragment, Package, resolve } from '@mdgate/containers';
...
import { isAbsoluteUri, trim, warn } from '@mdgate/utils';
import { type HtmlCtx, Stylesheet, toBlocks } from './html.js';
