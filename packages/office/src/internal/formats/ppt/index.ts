...
import { getU32, readOleStream } from '../../common/binary.js';
import { rebaseEmphasis, resolveDelta, type StyleDelta } from '../../common/delta.js';
import { flushList, type ListEntry } from '../../common/list.js';
import { decodeBlip, fbseBlip, recordAt } from '../../common/officeart.js';
...
import { MAX_ENTRY_BYTES, MAX_RECORD_DEPTH, MAX_RECORDS } from '../../package/limits.js';
import {
  type CharProps,
  emptyMasterLevel,
  emptyStyleRuns,
