#!/usr/bin/env python3
"""Regenerate the committed fixture corpus in test/fixtures/.

Sources live in test/fixture-src/. Real-producer files are generated through
...
Usage: python test/gen_fixtures.py [--skip-office]
"""
